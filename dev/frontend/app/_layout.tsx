...
export default function RootLayout() { const [loaded] = useFonts({ Nunito_400Regular, Nunito_600SemiBold, Nunito_700Bold, Nunito_800ExtraBold, NotoSansSinhala_400Regular, NotoSansSinhala_700Bold }); if (!loaded) return null; (Text as any).defaultProps = { ...(Text as any).defaultProps, style: [{ fontFamily: "Nunito_400Regular" }, (Text as any).defaultProps?.style] }; (TextInput as any).defaultProps = { ...(TextInput as any).defaultProps, textAlignVertical: "center" }; return <QueryClientProvider client={queryClient}><StatusBar style="dark" /><Stack screenOptions={{ headerShown: false }} /></QueryClientProvider>; }
