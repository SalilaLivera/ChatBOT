...
DATASET_PATH = os.environ.get(
    "SINBERT_DATASET_PATH",
    str(REPOSITORY_ROOT / "data" / "processed" / "PREGNANCY_FROZEN_TEST_SET.csv"),
)

MODEL_PATH = os.environ.get(
    "SINBERT_MODEL_PATH",
    r"C:\Users\Yasindu\.cache\huggingface\hub\models--sinhala-nlp--sinhala-sentiment-analysis-sinbert-small\snapshots\7059f20a28a2b1e2ff2f45b13d6956435cdacb6a\best_model",
)

OUTPUT_DIR = os.environ.get(
    "SINBERT_OUTPUT_DIR",
    str(REPOSITORY_ROOT / "outputs" / "baseline"),
)

# Repository-adapted version. The exact historical script is preserved as
# evaluate_sinbert_historical.py. This file is not a new evaluation result.
